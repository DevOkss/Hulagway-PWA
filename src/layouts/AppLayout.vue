...
const navItems = [
  ...
  { to: '/offline-records', label: 'Offline', icon: 'M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75' },
  { to: '/submitted-records', label: 'Submitted', icon: 'M9 12l2.25 3 3-3m-6 6h6M7.5 3v2.25m9-2.25V3M3.75 18.75h16.5M5.25 21h13.5' },
