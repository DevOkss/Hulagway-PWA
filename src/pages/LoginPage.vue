...
const backdropUrl = asset('images/login-backdrop.png')
const logoUrl = asset('images/logo-transparent.png')
  ...
  <div class="flex min-h-svh flex-col md:flex-row">
    ...
    >
      ...
      <div class="relative z-10 flex flex-col items-center text-center">
        ...
        />
        <h1
          class="font-heading text-2xl leading-tight font-extrabold tracking-wider text-orange-600 sm:text-3xl md:text-5xl"
        >
          HULAGWAY
        </h1>
        <p
          class="mt-1 text-[11px] font-semibold tracking-[0.05em] text-orange-600/90 uppercase sm:text-xs md:mt-4 md:text-sm"
        >
    ...
    <div
      class="flex flex-1 items-start justify-center bg-white px-6 py-5 sm:px-10 sm:py-6 md:items-center md:w-1/2"
    >
      <div class="w-full max-w-md">
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-5">
          ...
          <div>
            <div class="relative">
              <span
                class="pointer-events-none absolute top-0 bottom-0 left-0 flex items-center pl-4 text-orange-500"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                ...
                >
                  <path
                    d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25H5.25a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5H5.25a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75"
          ...
          <p v-if="auth.error" class="rounded-lg bg-red-50 px-3 py-2 text-xs text-red-500">
            {{ auth.error }}
          </p>
          ...
          >
            <span v-if="auth.loading" class="mx-auto flex items-center justify-center gap-2"
              ><span
